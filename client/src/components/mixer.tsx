      ...
      <CardContent className="space-y-5">
        <div className="space-y-3">
          <div className="flex items-center justify-between gap-2">
            <span className="text-xs font-medium text-muted-foreground">Deck A</span>
            <span className="text-xs font-mono text-muted-foreground">Crossfade</span>
            <span className="text-xs font-medium text-muted-foreground">Deck B</span>
          </div>
          <Slider
            value={[crossfade]}
            min={0}
