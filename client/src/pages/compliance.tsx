...
import { ArrowLeft, Shield, Scale, AlertTriangle, ExternalLink, Music, FileText, Info, BookOpen } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col" style={{ background: "linear-gradient(160deg, #0d0520 0%, #0a0519 100%)" }}>
      <div className="flex-1 max-w-3xl mx-auto px-6 py-8 w-full">
        <div className="flex items-center gap-3 mb-8">
          <button onClick={() => navigate("/")} className="p-2 rounded-xl hover:bg-white/5 transition-colors" data-testid="button-compliance-back">
            <ArrowLeft className="w-5 h-5 text-white/50" />
          </button>
          <Shield className="w-5 h-5 text-[#0af]" />
          <h1 className="text-2xl font-black text-white" data-testid="text-compliance-title">Compliance Center</h1>
        </div>
        ...
        <div className="bg-[#ffd60a]/10 border border-[#ffd60a]/30 rounded-2xl p-5 flex gap-4 mb-8">
        ...
        <div className="space-y-8">
          <section className="space-y-4">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-5 space-y-3 text-sm text-white/70 leading-relaxed">
              ...
              <p>
                This right is managed by organizations called <strong className="text-white">Performing Rights Organizations (PROs)</strong>. In the US, the main PROs are ASCAP, BMI, SESAC, and GMR.
              </p>
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="text-lg font-black text-white">2. ASCAP, BMI, SESAC, and GMR — Who Are They?</h3>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-2xl p-5 space-y-4 text-sm text-white/70 leading-relaxed">
              ...
              <div className="border-t border-white/5 pt-4 space-y-2">
                <p className="text-white font-bold">GMR (Global Music Rights)</p>
                <p>A newer PRO representing a selective but growing roster of high-profile songwriters.</p>
                <a href="https://www.gmr.net/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-[#0af] hover:underline text-xs" data-testid="link-gmr">
                  GMR Website <ExternalLink className="w-3 h-3" />
                </a>
              </div>
            </div>
          </section>
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="text-lg font-black text-white">4. Private Events</h3>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-2xl p-5 space-y-3 text-sm text-white/70 leading-relaxed">
              <p>Private events (house parties, private gatherings not open to the public) generally do not require public performance licenses. However, the line between private and public can be ambiguous. If you are unsure, treat the event as public and ensure licensing is in place.</p>
            </div>
          </section>

          <section className="space-y-4">
            <div className="flex items-center gap-2 mb-2">
              <Music className="w-5 h-5 text-[#ff9500]" />
              <h3 className="text-lg font-black text-white">5. Streaming Platform Restrictions</h3>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-2xl p-5 space-y-3 text-sm text-white/70 leading-relaxed">
              <p>If you use Spotify, Apple Music, or other streaming platforms through DJ Hybrid, be aware that streaming service licenses are granted for personal, non-commercial use. Using streamed audio in commercial DJ performances may require a separate agreement with the streaming platform.</p>
              <p>For commercial use, consider purchasing or licensing music through DJ-specific platforms such as:</p>
              <ul className="list-disc pl-5 space-y-1">
                <li><a href="https://www.beatport.com/" target="_blank" rel="noopener noreferrer" className="text-[#30d158] hover:underline">Beatport</a></li>
                <li><a href="https://www.beatsource.com/" target="_blank" rel="noopener noreferrer" className="text-[#30d158] hover:underline">Beatsource</a></li>
                <li><a href="https://www.djcity.com/" target="_blank" rel="noopener noreferrer" className="text-[#30d158] hover:underline">DJ City</a></li>
                <li><a href="https://www.traxsource.com/" target="_blank" rel="noopener noreferrer" className="text-[#30d158] hover:underline">Traxsource</a></li>
              </ul>
            </div>
          </section>
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="text-lg font-black text-white">6. Artist Marketplace & DJ Licensing</h3>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-2xl p-5 space-y-3 text-sm text-white/70 leading-relaxed">
              <p>
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="text-lg font-black text-white">7. Artist Uploads and Copyright</h3>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-2xl p-5 space-y-3 text-sm text-white/70 leading-relaxed">
              <p>If you are an artist uploading your music to DJ Hybrid, you must own or hold all necessary rights to the recording and the underlying composition. This includes both the master recording rights and the publishing rights.</p>
              <p>Uploading music you do not own violates our <a href="/dmca" className="text-[#bf5af2] hover:underline">DMCA Policy</a> and may result in account termination.</p>
            </div>
          </section>
        </div>

        <div className="mt-8 bg-[#bf5af2]/10 border border-[#bf5af2]/30 rounded-2xl p-6 text-center">
        ...
        <div className="mt-6 text-center pt-4 border-t border-white/10">
          ...
          <div className="flex gap-3 justify-center flex-wrap">
            ...
            <span className="text-white/20">·</span>
            <button onClick={() => navigate("/dmca")} className="text-xs text-white/50 hover:text-white/80 underline underline-offset-2 transition-colors" data-testid="link-dmca">
              DMCA Policy
            </button>
          </div>
        </div>
